...
use Illuminate\Http\Request;
...

			{
				...
				public function testcontroller(){
					...
					return \View::make('test_bootstrap.one');
				}
				...
				public function create(Request $request)
				{
					...
					{
						return redirect('blog')->withErrors('You have not sufficient permissions for writing post');
					}
				}
				...
				public function show($slug)
				{
					...
					if($post)
					{
						if($post->active == false)
							return redirect('blog')->withErrors('requested page not found');
